...
- ✨ **Modern look**: items open in a window that leads with the **image
  across the full width**; below it the name, tags and – for dealers –
  three tiles (paid, value, profit). The rest sits on three tabs (copy,
  prices, more) instead of stacking up. In the collection the product
  image shows as a subtle card background
